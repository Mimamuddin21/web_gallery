...
<body>
   ...
   <div class="container mt-3">
    ...
    <div class="card mt-2" style="margin-bottom: 70px;">
          ...
          <div class="table-responsive">
            <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <?php
                        ...
                        $userid = $_SESSION['userid'];
                        $no = 1;
                        $sql = mysqli_query($conn, "select * from album where userid='$userid' ORDER BY albumid DESC");
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="hapus_album.php?albumid=<?= $data['albumid'] ?>"
                                    class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')">Hapus</a>
